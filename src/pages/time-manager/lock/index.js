  ...
  render() {
    ...
    return (
      <View className='time-manager-lock'>
        <View className='time-manager-lock-tips'>锁屏时间段手机只能用来打电话发短信</View>
        ...
        <View className='time-manager-lock-top'>
          ...
          <View className='time-manager-lock-top-free'>
            <View className='time-manager-lock-top-free-color'> </View>
            <View>自由时间</View>
          </View>
          <View className='time-manager-lock-top-lock'>
            <View className='time-manager-lock-top-lock-color'> </View>
            <View className=''>锁屏时间</View>
          </View>
        </View>
        <View className='time-manager-lock-bottom'>
          <View className='time-manager-lock-bottom-time'>
            <View className='time-manager-lock-bottom-time-am'>上午</View>
            <View className='time-manager-lock-bottom-time-pm'>下午</View>
          </View>
          <View className='time-manager-lock-bottom-hours'>
            ...
            {currentDay.hours.map(item => {
              ...
              return (<View className={classname} onClick={this.onSelectHour.bind(this, item)}>{item}</View>)
            })}
          </View>
        </View>
